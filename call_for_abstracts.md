...
Submit via Microsoft CMT: [https://cmt3.research.microsoft.com/BAYLEARN2026](https://cmt3.research.microsoft.com/BAYLEARN2026)
...
Submit your abstracts via CMT: [https://cmt3.research.microsoft.com/BAYLEARN2026](https://cmt3.research.microsoft.com/BAYLEARN2026)
...
The conference will be held in-person. At least one author for each accepted abstract is requested to physically attend the conference to present their work.

The organizers will *desk reject* submissions based on the following criteria:
* Have formatting issues, e.g., not following the formatting guidelines or template.
* Exceed the 2 page limit.  This includes using hyperlinks for extended content.
* Have non-anonymized submissions.
